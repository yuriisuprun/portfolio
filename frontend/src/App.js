...
const routeConfig = (language) => [
    {
        path: "/home",
        component: <Hero language={language}/>,
        seo: {
    ...
    {
        path: "/projects",
        component: <Projects language={language}/>,
        seo: {
    ...
    {
        path: "/contacts",
        component: <Contacts language={language}/>,
        seo: {
            ...
            <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 flex flex-col flex-grow">
                ...
                <main className="flex-grow">
                    <Routes>
                        ...
                        {routeConfig(language).map(({path, component, seo}) => (
                            <Route
                                key={path}
                                path={path}
                                element={
