...
export const MESSAGES = {
  en: {
    nav: {
      ...
      darkModeToLightAria: "Switch to light mode",
  ...
  it: {
    nav: {
      ...
      switchToEnglishAria: "Passa all'inglese",
      darkModeToLightAria: "Passa alla modalita chiara",
    ...
    contacts: {
      ...
      error: "Ops! Qualcosa e andato storto. Riprova.",
      fields: {
        name: "Il tuo nome",
        email: "La tua email",
    ...
    footer: {
      designedBy: "Progettato e realizzato da",
      with: "con",
    },
  },
};
