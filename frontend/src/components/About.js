export default function About({ language }) {
    ...
    const text = {
        en: {
            title: "About Me",
            description:
                "I'm Yurii and I’m a Software Engineer passionate about building scalable and reliable systems. My primary expertise lies in Java, Spring Boot, and microservices architectures, combined with cloud-native technologies such as AWS, Docker, and Kubernetes. I also have experience contributing to user interface development, which helps me better understand the full application stack and deliver cohesive solutions. I’m always open to adopting new technologies whenever they best fit the problem or project requirements.\n" +
                "\n" +
                "Over the years, I’ve contributed to designing and modernizing complex platforms across multiple domains (Insurance, Travel, Finance, etc.), with a strong focus on clean architecture, performance, and long-term maintainability. I enjoy learning new technologies, solving challenging problems, and collaborating with multicultural teams to deliver high-quality software."
        },
        it: {
            title: "Chi Sono",
            description:
